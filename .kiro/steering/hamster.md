...
When working with Hamster briefs, follow the standard Git workflow patterns outlined in [git_workflow.md](.kiro/steering/git_workflow.md):
...
- [git_workflow.md](.kiro/steering/git_workflow.md) - Standard Git branching and PR practices
- [dev_workflow.md](.kiro/steering/dev_workflow.md) - General Task Master development patterns
- [tasks.md](.kiro/steering/tasks.md) - Task structure and operations
